...
class SWPA_Plugin_Template_Settings {
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="options-general.php?page=swpa_settings">' . __( 'Settings', 'swpa' ) . '</a>';
		...
		$settings['Settings'] = array(
			...
			'fields'				=> array(
                ...
                array(
                    ...
                    'description'	=> __( 'Here you can set logo height in px.', 'swpa' ),
                    'type'			=> 'number',
                    'default'		=> '100',
                ...
                array(
                    ...
                    'description'	=> __( 'Here you can set logo width in px.<br><b>Note: keep both height and width same for neat look.<b>', 'swpa' ),
                    'type'			=> 'number',
                    'default'		=> '100',
                    'placeholder'	=> __( '42', 'swpa' )
                ),
